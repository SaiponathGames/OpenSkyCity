...
# 						z = p4[int(k)]
# 						print(
# 							"The key " + p.bold + x + p.normal + " is " + n + " version. The username of " + p.bold + x + p.normal + " is " + p.italic + str(
# 								z).replace('_', ' ') + p.normal + ".")
# 				else:
# 					print("Can't able to find " + x + " in the database, please check the key again!")
# 				k += 1
# 		else:
# 			k = 0
# 			for _ in p4:
...
# 									print(x4[0])
# 						else:
# 							print("Can't able to find the " + io + " in the database, please check the name again!")
# 					k += 1
# 			else:
